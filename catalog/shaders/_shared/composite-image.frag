...
// crop-fit. No V-flip here: the image bitmap is pre-flipped on upload, so the
// texture already lands semantic-top at v=1. Web also uses this as its blit shader
// (scratch -> output at cover scale 1,1); iOS has a distinct composite-blit.
//
