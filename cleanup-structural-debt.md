...
- ✅ `f967838` — **W4 components**: `controls/` + `ui/` → `src/components/{picker,tuner,ui,form,theme}`; public subpaths `./ui` → `./picker`, `./controls` → `./tuner`. `resolve-background-uri` rename deferred (native-coupled).
