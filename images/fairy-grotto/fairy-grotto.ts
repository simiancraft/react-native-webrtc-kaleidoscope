...
// Web is handled by fairy-grotto.web.ts. This is a fairy-cave root-grotto plate
// (the round opening cut out so the sky shows through behind it).
export const fairyGrotto: PresetSource = 'fairy-grotto';
